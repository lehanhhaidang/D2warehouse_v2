...
class InventoryReportCancelled implements ShouldBroadcastNow
{
    ...
    {
        return 'inventory-report.cancelled';
    }
    ...
    public function broadcastWith()
    {
        Notification::create([
            ...
            'message' => User::find(Auth::id())->name . ' đã hủy ' . $this->inventoryReport->name . ' của bạn. Hãy thực hiện kiểm kê lại.',
        ...
        return [
            'event' => 'inventory-report.cancelled',
            'owner_message' => User::find(Auth::id())->name . ' đã hủy ' . $this->inventoryReport->name . ' của bạn. Hãy thực hiện kiểm kê lại.',
